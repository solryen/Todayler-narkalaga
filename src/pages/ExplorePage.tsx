    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="mx-auto max-w-7xl px-6 lg:px-10 py-16">
        <header className="mb-16 border-b border-stone-200 pb-10">
          ...
          <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl leading-[0.95] text-stone-900 mb-6 italic">
        ...
        {/* Filter Bar */}
        <div className="bg-stone-50 p-6 border border-stone-200 mb-12 flex flex-col sm:flex-row gap-6 items-center z-20 relative">
          ...
          <div className="relative flex-1 w-full max-w-md ml-auto mt-2 sm:mt-0">
            <div className="text-[10px] uppercase tracking-tighter opacity-50 mb-2">
