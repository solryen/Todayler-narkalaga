...
export function ArticlePage() {
  ...
  return (
    <article className="min-h-screen bg-stone-50 pb-20 border-t border-stone-200">
      ...
      {/* Breadcrumbs */}
      <div className="mx-auto max-w-[900px] px-6 lg:px-10 py-6 text-[9px] uppercase tracking-widest text-stone-500 font-medium flex flex-wrap gap-2 items-center">
      ...
      <header className="mx-auto max-w-[900px] px-6 lg:px-10 py-8 text-center">
        <div className="inline-block px-2 py-1 bg-orange-600 text-white text-[9px] uppercase tracking-widest w-fit mb-6">
          {article.category}
        </div>
        
        <h1 className="font-serif text-5xl lg:text-7xl leading-[0.95] text-stone-900 mb-8 italic">
          {article.title}
        </h1>

        {article.subtitle && (
           <p className="text-lg lg:text-xl text-stone-700 opacity-90 max-w-[700px] mx-auto leading-relaxed mb-8">
             {article.subtitle}
           </p>
        )}

        <div className="flex items-center justify-center gap-6 text-[10px] uppercase tracking-[0.2em] font-medium text-stone-600">
      ...
      {article.featured_image_url && (
         <div className="w-full max-w-[1200px] mx-auto relative aspect-[21/9] bg-stone-200 border-y sm:border border-stone-200 mb-16">
            <img 
      ...
      <div className="mx-auto max-w-[1000px] px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-[1fr_250px] gap-16 items-start">
        <div className="min-w-0">
          
          {article.expert_reviewed && (
            <div className="mb-10 p-6 bg-stone-100 border border-stone-200 flex items-center justify-center gap-4">
              <span className="font-serif italic text-lg text-stone-900">Expert Reviewed</span>
          ...
          {/* Subtle Inline Promo */}
          <div className="mb-10 bg-[#EAE7E0]/40 border-l-2 border-orange-600 p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
          ...
          {/* Author Bio Section */}
          <div className="mt-16 bg-stone-100 border border-stone-200 p-8 flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
          ...
          <div className="mt-20 pt-16 border-t border-stone-200">
             {/* CTA Block */}
             <div className="bg-[#EAE7E0] border border-[#E5E1D8] p-10 sm:p-14 flex flex-col sm:flex-row items-center justify-between gap-10 mt-12 mb-12">
                <div className="text-center sm:text-left">
                  <div className="text-[10px] uppercase tracking-[0.2em] mb-4 text-[#8B7E66] font-medium">Get the App</div>
                  <h3 className="font-serif text-3xl mb-3 italic">Todayler</h3>
      ...
      <div className="border-t border-stone-200 mt-20 bg-stone-100 py-20">
