    ...
    <div className="min-h-screen bg-stone-50 py-16">
      <div className="max-w-4xl mx-auto px-6 lg:px-10">
        <div className="mb-10">
          ...
          <h1 className="font-serif text-5xl text-stone-900 mt-4 italic">Publish New Article</h1>
        </div>

        <form className="space-y-8 bg-white p-8 sm:p-12 border border-stone-200" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="pt-6 border-t border-stone-200 flex flex-col sm:flex-row gap-4">
            <button 
              ...
              className="flex-1 bg-white border border-stone-300 text-stone-900 py-4 text-[10px] uppercase tracking-widest font-bold hover:bg-stone-50 transition-colors"
            >
              Save as Draft
            </button>
            <button 
              ...
              className="flex-1 bg-stone-900 text-stone-50 py-4 text-[10px] uppercase tracking-widest font-bold hover:bg-stone-800 transition-colors"
            >
              Publish Now
            </button>
          </div>
