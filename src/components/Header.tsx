  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-stone-50 border-b border-stone-200">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <Link to="/explore" aria-label="Todayler Home" className="text-stone-900 hover:opacity-70 transition-opacity">
          <span className="text-3xl font-serif italic tracking-tight font-semibold">Todayler.</span>
        </Link>
        <GlobalSearch />
        <nav aria-label="Main navigation" className="flex gap-4 sm:gap-6 text-[10px] sm:text-[11px] uppercase tracking-widest font-medium text-stone-900 items-center">
