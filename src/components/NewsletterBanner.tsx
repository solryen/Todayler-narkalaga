...
export function NewsletterBanner() {
  ...
  if (status === 'success') {
    return (
      <div className="bg-stone-900 p-8 sm:p-12 text-center border border-stone-900 text-stone-50">
        <h3 className="font-serif text-3xl sm:text-4xl leading-[1.1] mb-4">
  ...
  return (
    <div className="bg-stone-900 p-8 sm:p-12 border border-stone-900 overflow-hidden relative text-stone-50">
      <div className="relative z-10 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <h2 className="font-serif text-4xl sm:text-5xl leading-[1.1] mb-6">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="block w-full rounded-none border border-stone-700 bg-stone-800 px-4 py-3 text-stone-50 placeholder-stone-500 focus:border-orange-600 focus:outline-none text-xs tracking-widest font-medium transition-colors"
              />
              <button
                type="submit"
                disabled={status === 'loading'}
                className="inline-flex justify-center flex-shrink-0 items-center rounded-none bg-white px-6 py-3 text-[10px] uppercase tracking-widest font-bold text-stone-900 border border-white hover:bg-stone-200 hover:border-stone-200 focus:outline-none transition-colors disabled:opacity-70"
              >
