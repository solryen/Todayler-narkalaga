...
- Create or invite one Supabase Auth user for the editor/admin email.
- Keep that email in `VITE_SUPABASE_ADMIN_EMAIL` locally so the UI and the Edge Function agree on which account may edit articles.
